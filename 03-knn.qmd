...
- compute neighbor votes by hand
- compare k-NN decision boundaries for different $k$
- measure raw versus scaled k-NN on real data
- inspect how scaling changes the nearest neighbors
- tune $k$, metric, weighting, and scaler with cross-validation

Open `lab-02-knn.ipynb`.
