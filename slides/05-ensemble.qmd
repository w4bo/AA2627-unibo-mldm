...
- *Boosting* reduces **bias** and often variance, but may become sensitive to noise (e.g., Adaboost [@freund1997decision], XGBoost [@chen2016xgboost], and LightGBM [@ke2017lightgbm])
    - Could be target algorithms for your assignment!
