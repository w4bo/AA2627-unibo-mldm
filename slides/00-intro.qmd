...
- Goal: Introduction to Machine Learning (main focus on models)

*Module II (ML&DM; DTM) = Module I (DCAI; CSE), 30h* (Prof. Golfarelli)

- Goal: Introduction to Data-Centric AI (main focus on data quality and understanding)
...
| Month Week | ML&DM<br>Mod I<br>DTM<br>Francia | ML&DM / DCAI<br>Mod II<br>DTM + CSE<br>Golfarelli | DCAI<br>Mod II<br>CSE<br>Francia |
| :--------: | :------------------------------: | :---------------------------------------: | :------------------------------: |
| Sep 3      |                     **10 hours** |                                           |                                  |
| Sep 4      |                     **10 hours** |                                           |                                  |
| Oct 1      |                     **--**       |                                           |                                  |
...
# Exam: Book the exam *when you are ready*

The final grade is the result of an oral exam.

- There are no scheduled dates: book each exam when you are prepared.
    - **Mandatorily** use the [Booking application](https://outlook.office.com/book/DCAIMLDMDataCentricAIMachineLearningandDataMining@live.unibo.it)!
...
**Active participation** during lectures and labs is considered in the final evaluation.
...
1. Email me an assignment proposal including:
    - Option 1: Dataset description and link; the dataset must require some pre-processing
    - Option 2: Algorithm description and link to the paper
1. Wait for approval

Then, register the assignment using the [Google Form](https://forms.gle/pC5dA1WjATUxh3jCA)

- Develop the assignment in Google Colab
...
1. Prepare a **10-minute presentation** with no more than 10-12 slides (~1 per minute!)
...
![Hands on ML](./img/remote/oreilly-hands-on-ml-cover.jpg)
...
- [Course and exam details](00-intro)
- [Introduction to AI and machine learning](01-ml)
- [Laboratory on Colab and main libraries](lab-00-basics)
- Supervised learning
    - Classifiers
        - [Decision trees](02-dt)
        - [k-NN](03-knn)
        - [Neural networks](04-neuralnetworks)
        - [Ensemble methods](05-ensemble)
        - [Lab on classification](lab-03-classification)
        - [Lab on modeling and HPO](lab-10-modeling)
    - [Evaluation of classifiers](08-evaluation)
- Unsupervised learning
    - Clustering: [theory](06-clustering) + [lab](lab-04-clustering)
    - Association rules: [theory](07-association) + [lab](lab-05-association)
...
# "Oh, and keep an eye on the <s>staircases</s> slides. They like to change."

During the lecture period, it is likely that slides will be frequently updated (even daily or right after classes). 

- Please, (re)check the slides right before each lecture!
