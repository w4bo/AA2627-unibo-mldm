...
- [Introduction to AI and machine learning](01-ml)
    - [Data splits, evaluation, and leakage](evaluation)
...
Every lecture separates material into three levels.
...
| **Extension** | Useful for deeper study, advanced assignments, or context, but not the first thing to master |

The labels are meant to help you study strategically. They do not replace the syllabus or the instructor's guidance during class.
