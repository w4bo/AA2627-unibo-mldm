...
rejected_income = rng.normal(38_000, 10_000, 260)
accepted_income = rng.normal(72_000, 14_000, 260)
rejected_income = np.clip(rejected_income, 12_000, 105_000)
accepted_income = np.clip(accepted_income, 12_000, 105_000)

bins = np.arange(10_000, 111_000, 5_000)
...
ax.annotate(
    ...
    xytext=(threshold + 7_000, ax.get_ylim()[1] * 0.92),
...
ax.set_title("A simple rule separates most observations")
