...
- Performance on new data-not memorization of training examples-is the central goal (i.e., generalize to unseen dat)
...
Given a **dataset**, i.e. a collection of records:

- Each record has a set of **features**
- During training, one attribute provides the known **class** or **label**
...
# Computer science is about ideas, not machines {background-color="#121011"}
