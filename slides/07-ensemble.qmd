...
![](img/ensemble/decision-level-fusion.png)
...
The sum is often more robust than the product: if one classifier assigns confidence 0, a product rule forces the whole combined confidence to 0.

![](img/ensemble/confidence-fusion.jpeg)
...
![](img/ensemble/random-forest.png)
...
![Bagging vs boosting](img/ensemble/bagging-vs-boosting.png)
...
![](img/ensemble/adaboost-flow.png)
