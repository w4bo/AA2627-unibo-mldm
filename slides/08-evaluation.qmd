...
The same domain can differ: **automatic fraud blocking favors precision**, while a **fraud-review queue favors recall**.

- Choose the metric and threshold from the consequences of FP and FN.
