...
| **Extension** | C4.5 details, MDL, pessimistic pruning, and bootstrap estimates |
...
- Built decision trees can have different split attributes and conditions depending on the records in each training fold
...
| Failure modes | Instability, overfitting, and misleading accuracy under imbalance |
