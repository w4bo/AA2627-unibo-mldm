...
# Learning the tree (in the next slides)
...
# Learning the tree {background-color="#121011"}
...
ROC graphs are 2D charts that depict relative tradeoffs between benefits (TP) and costs (FN) induced by a classifier. 
