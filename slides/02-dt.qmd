...
- Let $D_t=\{x_1, ..., x_k\}$ be the records of the training set corresponding to $node_t$ and $y_t = \{y_1, ..., y_k\}$ the possible class labels
...
::::{.columns}
:::{.column width=50%}
*N-ary split*: The split condition can be expressed as a Boolean test that results in multiple ranges of values.
...
:::
:::{.column width=50%}
*Binary split*: The split condition can be expressed as a binary comparison test.
