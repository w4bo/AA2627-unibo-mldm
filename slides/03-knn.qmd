...
:::
:::{.column width=50%}
![Comparison of Chebyshev, Euclidean and Manhattan (Taxicab) distances](https://thumb.wikimedia.org/wikipedia/commons/thumb/e/eb/Minkowski_distance_examples.svg/960px-Minkowski_distance_examples.svg.png?utm_source=en.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail)
:::
::::
...
| Neighbor | Distance from $z$ | `churn` | Weight $1/dist$ |
|:---:|:---:|:---:|:---:|
| $x_1$ | 0.5 | ❌ | 2.00 |
| $x_2$ | 1.1 | ✅ | 0.91 |
| $x_3$ | 1.3 | ✅ | 0.77 |
...
# Min-max scaling (forward reference to Mod II)
...
# Failure case: irrelevant features (forward reference to Mod II)

Scaling fixes unequal units, but k-NN is sensitive to the number of features.
