...
* The search for this type of anomaly aims to exclude it from the dataset, since it represents noise that may impair the quality of analysis results
...
In a density-based approach, an outlier is an element of the dataset located in an area of very low density
...
Relative density is used to locally measure the tendency of a point to be an outlier: __Local Outlier Factor__ (LOF)
