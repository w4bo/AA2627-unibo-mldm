...
Fist, split the original dataset into non-overlapping *training* and *test* sets
...
Then, learn the model from the training set

Finally, use the test set only to evaluate performance on unseen records
